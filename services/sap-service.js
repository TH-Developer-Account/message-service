...
export class SAPService {
  ...
  async _fetchViaBYD(poNumber, isSalesOrder) {
    ...
    const response = await messageAxios.get(baseURL, {
      params: {
        $select:
          "C1GULUTW2TC5UU3ZM5CHWO5ZPKM,T1GULUTW2TC5UU3ZM5CHWO5ZPKM,CDOC_UUID,Cs1ANs8A8039F88126A08,Cs1ANsB3D7B663E8C86DE,CIBR_OD_UUID,CIPR_PROD_UUID,CIBR_SLO_UUID,CIBR_SLO_ITM_UUID,Cs1ANsBEDFB09D6BC236C,TDOC_PROC_TYPE,CDOC_PROC_TYPE,CY4M9FABQY_8001EAF3C1",
